...
def InfoAcc(username, gg):
    ...
    total += 1
    url = 'https://t.me/SIN_PHP'
    img_url = f"https://image.thum.io/get/{url}"
...
❖️ - EMAIL :  {username}@{gg}
❖️ -  REST : {r}
❖️ - LINK : https://www.instagram.com/{username}/
⋘──────⋙
Dev : @SIN_PHP
'''
    ...
    print(ss)
    l=open("site.png", "rb")
    bot.send_photo(chat_id=ID,photo=l, caption=ss)
    ...
    while True:
        data = {
            ...
            "variables": json.dumps({
                "id": "".join(random.choice('1234567890')for i in range(random.randint(9,10))),
